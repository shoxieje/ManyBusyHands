                        ...
                        <b-row class="justify-content-center">
                            ...
                            <b-col md="6" sm="auto" id="login-box">
                                ...
                                <b-form id="login-form" class="form">
                                    <!-- LOGIN INPUTS -->
                                    <b-form-group label="Email" label-for="loginEmail" class="login-label mt-4" :state="validLoginEmail" invalid-feedback="Invalid email address, use format example@domain.com">
                                        <b-form-input type="text" name="loginEmail" id="loginEmail" v-model="loginEmail" trim :state="validLoginEmail"/>
                                    </b-form-group>
                                    
                                    <b-form-group label="Password" label-for="loginPassword" class="login-label" :state="validPassword" :valid="false" invalid-feedback="Password must be at least 6 characters">
                                        <b-form-input type="password" name="loginPassword" id="loginPassword" v-model="loginPassword" trim :state="validPassword"/>
                                    </b-form-group>
                                    <!-- LOGIN BUTTON (BUTTONS FOR SUBMISSION TO MOCK USERS) -->
                                    <b-form-group class="mb-4">
                                        <br>
                                        <b-button variant="primary" size="md" class="w-100 mt-3 mm-2" @click="login">Sign in</b-button>
                                    </b-form-group>
                                    ...
                                    <!-- REGISTRATION LINKS -->
                                    <div id="signup-list">
                                        <p>Don't have an account? <router-link class="text-right" style="color: #4964e9" to="/Business/Signup">Create an account</router-link> </p> 
                                    </div>
                                </b-form>
                            </b-col>
                        </b-row>
