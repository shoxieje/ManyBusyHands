<template>
    <b-container class="container-job">
        <b-form id="create-job-form" class="">
            <div class="create-job-box">
                ...
                <b-row class="my-1">
                    <b-col sm="12">
                        <div class="award-container">
                            <label for="award" class="required-field"
                                >Applicable Award
                            </label>
                            <a
                                color="black"
                                href="https://www.fairwork.gov.au/employment-conditions/awards/list-of-awards"
                                >Don't know your award?</a
                            >
                        </div>
                ...
                <b-row class="my-1"> <b-col sm="6"></b-col></b-row>
            </div>
        </b-form>
    </b-container>
</template>
