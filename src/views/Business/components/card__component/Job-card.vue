            ...
            <div class="sr-content__container">
                <div class="sr-content">
                    ...
                    <div>
                        ...
                        {{ job.suburb + " " + job.postcode + " " + job.state }}
                        <br />
                        {{ job.industry }} <br />
            ...
            this.$vToastify
                ...
                .then((value) => {
                    if (value) {
                        ...
                        let index = this.$store.state.active_job_ad.findIndex(
                            (x) =>
                                x.random_url_job_id ===
                                this.job.random_url_job_id
                        );
                        this.$store.dispatch("pushInactiveAd", [
                            this.job,
                            index,
                        ]);
                        ...
                        axios
                            .put(
                                `http://localhost:8081/jobAd/inactivateJobAd`,
                                new URLSearchParams({
                                    date: currentDate,
